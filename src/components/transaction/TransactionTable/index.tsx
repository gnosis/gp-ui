      ...
      <td>
        ...
        <HeaderValue>
          <RowWithCopyButton
            ...
            textToCopy={uid}
            contentsToDisplay={
              <LinkWithPrefixNetwork to={`/orders/${transaction.uid}`} rel="noopener noreferrer" target="_blank">
...
const TransactionTable: React.FC<Props> = ({ transactions, showBorderTable = false }) => {
